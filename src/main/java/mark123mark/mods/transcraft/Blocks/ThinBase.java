...
public class ThinBase extends Block {
	public String[] textureNames;
	public String folder;
	public Icon[] icons;
	public Icon[] sideIcons;

	public ThinBase(int id, Material material, String folder,
	...
	public boolean canConnectTo(int blockID) {
		...
		return Block.opaqueCubeLookup[blockID] || block instanceof ThinBase
				|| block instanceof BlockPane || blockID == Block.glass.blockID;
	}
	...
	public void registerIcons(IconRegister iconRegister) {
		...
		for (int i = 0; i < this.icons.length; ++i) {
			this.icons[i] = iconRegister.registerIcon("Transcraft:" + folder
					+ textureNames[i]);
			this.sideIcons[i] = iconRegister.registerIcon("Transcraft:"
					+ folder + textureNames[i] + "_side");
		}
	}
	...
	public boolean shouldSideBeRendered(IBlockAccess iblockaccess, int i,
		...
		if (Block.blocksList[bID] instanceof ThinBase
				|| Block.blocksList[bID] instanceof BlockPane) {
			return false;
		} else {
