...
public class EventCloakRender {
	...
	public EventCloakRender() {
		...
		cloaks.put(
				"mark123mark",
				"https://dl.dropboxusercontent.com/s/u32tnmr6pta5cx8/transcraft_dev.png?dl=1&token_hash=AAGmcRjgBcuQ548v6cMRRFbP0Rxp04pJvTVaKxJfUhOyaQ");

		cloaks.put(
				"Drewzombie",
				"https://dl.dropboxusercontent.com/s/pare4eq4xxr79nm/transcraft_gen.png?dl=1&token_hash=AAGP-HI1tgv4m9PGWvInRz2icyUA-HdRNZtMW0KruU_rTw");
		cloaks.put(
				"DrumBaseCZ",
				"https://dl.dropboxusercontent.com/s/pare4eq4xxr79nm/transcraft_gen.png?dl=1&token_hash=AAGP-HI1tgv4m9PGWvInRz2icyUA-HdRNZtMW0KruU_rTw");
		cloaks.put(
	...
	public void onPreRenderSpecials(RenderPlayerEvent.Specials.Pre event) {
		...
		if (event.entityPlayer instanceof AbstractClientPlayer) {
			...
			if (!capePlayers.contains(abstractClientPlayer)) {
				...
				new Thread(new CloakThread(abstractClientPlayer, cloakURL))
						.start();
			...
			while ((str = br.readLine()) != null) {
				if (!str.startsWith("--")) {
					if (str.contains(":")) {
						...
						System.err
								.println("[Transcraft] [skins.txt] Syntax error on line "
										+ linetracker + ": " + str);
					}
				}
				linetracker++;
