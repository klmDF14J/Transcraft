package mark123mark.mods.transcraft.Renders.particles;
...
public class OreParticle extends EntityPortalFX {
	...
	public OreParticle(World par1World, double par2, double par4, double par6,
	...
	public void renderParticle(Tessellator tessellator, float par2, float par3,
		...
		tessellator.addVertexWithUV((double) (f11 - par3 * f10 - par6 * f10),
				(double) (f12 - par4 * f10), (double) (f13 - par5 * f10 - par7
