...
public class LoadItems {
	...
	{
		Transcraft.BasicTransmuter = new BasicTransmuter(Config.BasicTransmuterID)
		...
		.setCreativeTab(Transcraft.TranstabItems).setTextureName("transcraft:Oil");
		...
		Config.PlasticAxeID, Transcraft.PlasticTool).setUnlocalizedName(
		"Transcraft:PlasticAxe").setCreativeTab(Transcraft.TranstabItems);
		
		Transcraft.PlasticHoe = new mark123mark.mods.transcraft.Tools.PlasticHoe(
		Config.PlasticHoeID, Transcraft.PlasticTool).setUnlocalizedName(
		"Transcraft:PlasticHoe").setCreativeTab(Transcraft.TranstabItems);
		
		Transcraft.PlasticPickaxe = new mark123mark.mods.transcraft.Tools.PlasticPickaxe(
		Config.PlasticPickaxeID, Transcraft.PlasticTool).setUnlocalizedName(
		"Transcraft:PlasticPickaxe").setCreativeTab(Transcraft.TranstabItems);
		
		Transcraft.PlasticShovel = new mark123mark.mods.transcraft.Tools.PlasticShovel(
		Config.PlasticShovelID, Transcraft.PlasticTool).setUnlocalizedName(
		"Transcraft:PlasticShovel").setCreativeTab(Transcraft.TranstabItems);
		
		Transcraft.PlasticSword = new mark123mark.mods.transcraft.Tools.PlasticSword(
		Config.PlasticSwordID, Transcraft.PlasticTool).setUnlocalizedName(
		"Transcraft:PlasticSword").setCreativeTab(Transcraft.TranstabItems);
		
Transcraft.BunkerPick = new mark123mark.mods.transcraft.Tools.BunkerPick(
		Config.BunkerPickID, Transcraft.BunkerToolEnum).setUnlocalizedName(
		"Transcraft:EnderPick").setCreativeTab(Transcraft.TranstabItems);

Transcraft.EnderSword = new mark123mark.mods.transcraft.Tools.EnderSword(
		Config.EnderSwordID, Transcraft.EnderToolEnum).setUnlocalizedName(
		"Transcraft:EnderSword").setCreativeTab(Transcraft.TranstabItems)
		.setFull3D();



EnumArmorMaterial PlasticEnum = EnumHelper.addArmorMaterial("Plastic",15, new int[] { 3, 5, 5, 2 }, 5);
