...
Transcraft.enderQuartz = new mark123mark.mods.transcraft.Blocks.EnderQuartz(
		Config.BlockEnderQuartzID)
.setUnlocalizedName("Transcraft:enderquartz")
.setTextureName("Transcraft:enderquartz").setHardness(1.0F)
.setCreativeTab(Transcraft.TranstabBlocks);

Transcraft.chiselEnderQuartz = new mark123mark.mods.transcraft.Blocks.EnderQuartz(
...
Transcraft.BlueenderQuartz = new mark123mark.mods.transcraft.Blocks.EnderQuartz(
...
Transcraft.BluechiselEnderQuartz = new mark123mark.mods.transcraft.Blocks.EnderQuartz(
...
Transcraft.RedenderQuartz = new mark123mark.mods.transcraft.Blocks.EnderQuartz(
...
Transcraft.RedchiselEnderQuartz = new mark123mark.mods.transcraft.Blocks.EnderQuartz(
...
Transcraft.StairenderQuartz = (new mark123mark.mods.transcraft.Blocks.DefultStair(
		Config.StairBlockEnderQuartzID , Transcraft.enderQuartz , 0))
.setUnlocalizedName("Transcraft:Stairenderquartz").setHardness(1.0F)
.setTextureName("Transcraft:Stairenderquartz")
.setCreativeTab(Transcraft.TranstabBlocks);

Transcraft.StairchiselEnderQuartz = (new mark123mark.mods.transcraft.Blocks.DefultStair(
		Config.StairBlockChiselEnderQuartzID, Transcraft.chiselEnderQuartz , 0))
.setUnlocalizedName("Transcraft:Stairchiselenderquartz").setHardness(1.0F)
.setTextureName("Transcraft:Stairchiselenderquartz")
.setCreativeTab(Transcraft.TranstabBlocks);

Transcraft.StairBlueenderQuartz = (new mark123mark.mods.transcraft.Blocks.DefultStair(
		Config.StairBlueBlockEnderQuartzID , Transcraft.BlueenderQuartz , 0))
.setUnlocalizedName("Transcraft:StairBlueenderquartz").setHardness(1.0F)
.setTextureName("Transcraft:StairBlueenderquartz")
.setCreativeTab(Transcraft.TranstabBlocks);

Transcraft.StairBluechiselEnderQuartz = (new mark123mark.mods.transcraft.Blocks.DefultStair(
		Config.StairBlueBlockChiselEnderQuartzID, Transcraft.BluechiselEnderQuartz , 0))
...
Transcraft.StairRedenderQuartz = (new mark123mark.mods.transcraft.Blocks.DefultStair(
		Config.StairRedBlockEnderQuartzID, Transcraft.RedenderQuartz , 0))
.setUnlocalizedName("Transcraft:StairRedenderquartz").setHardness(1.0F)
.setTextureName("Transcraft:StairRedenderquartz")
.setCreativeTab(Transcraft.TranstabBlocks);

Transcraft.StairRedchiselEnderQuartz = (new mark123mark.mods.transcraft.Blocks.DefultStair(
