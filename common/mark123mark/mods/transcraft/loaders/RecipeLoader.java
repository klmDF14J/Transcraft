...
public class RecipeLoader {
	...
	public static void LoadRecipe()
	{
		...
		GameRegistry.addRecipe(new ItemStack(Transcraft.PlasticHelmet, 1), "ppp", "p p",
				"   ", 'p', Transcraft.Plastic);
		GameRegistry.addRecipe(new ItemStack(Transcraft.PlasticChest, 1), "p p", "ppp",
				"ppp", 'p', Transcraft.Plastic);
		GameRegistry.addRecipe(new ItemStack(Transcraft.PlasticLegs, 1), "ppp", "p p",
				"p p", 'p', Transcraft.Plastic);
		GameRegistry.addRecipe(new ItemStack(Transcraft.PlasticBoots, 1), "   ", "p p",
				"p p", 'p', Transcraft.Plastic);

		GameRegistry.addRecipe(new ItemStack(Transcraft.ComIronOre, 1), "ii", "ii", 'i',
				Block.oreIron);
		GameRegistry.addRecipe(new ItemStack(Transcraft.ComGoldOre, 1), "ii", "ii", 'i',
				Block.oreGold);
		GameRegistry.addRecipe(new ItemStack(Transcraft.ComTransmutterOre, 1), "ii", "ii",
				'i', Transcraft.TranscraftOre);
		GameRegistry.addRecipe(new ItemStack(Transcraft.ComOilOre, 1), "ii", "ii", 'i',
				Transcraft.Oil);
		...
		GameRegistry.addRecipe(new ItemStack(Transcraft.TranscraftOre, 4), "i", 'i',
				Transcraft.ComTransmutterOre);
		GameRegistry.addRecipe(new ItemStack(Transcraft.Oil, 4), "i", 'i', Transcraft.ComOilOre);

		GameRegistry.addRecipe(new ItemStack(Transcraft.HotDog, 8), "bbb", "ppp", "bbb",
				'b', Item.bread, 'p', Item.porkCooked);

		GameRegistry.addRecipe(new ItemStack(Transcraft.ObsidianLever, 2), "lb ", "   ",
				"  ", 'l', Block.lever, 'b', Transcraft.BunkerBlock);

		GameRegistry.addRecipe(new ItemStack(Block.sponge, 16), "yxy", "xdx",
				"yxy", 'x', Water, 'y', GoldIStack, 'd', Item.diamond);

		GameRegistry.addRecipe(new ItemStack(Transcraft.BunkerBlock, 8), "opo", "pdp",
				"opo", 'o', Transcraft.HardendPlastic, 'p', Transcraft.Plastic, 'd', Item.diamond);
		GameRegistry.addRecipe(new ItemStack(Transcraft.ClearGlass, 8), "ggg", "gpg",
				"ggg", 'g', Block.glass, 'p', Transcraft.Plastic);
		GameRegistry.addRecipe(new ItemStack(Transcraft.FancyCrystalGlass, 8), "ggg",
				"gpg", "ggg", 'g', Transcraft.ClearGlass, 'p', Block.sponge);
		GameRegistry.addRecipe(new ItemStack(Transcraft.ThinClearGlass, 8), "   ", "ggg",
				"ggg", 'g', Transcraft.ClearGlass);
		GameRegistry.addRecipe(new ItemStack(Transcraft.BunkerStair, 4), "b  ", "bb ",
				"bbb", 'b', Transcraft.BunkerBlock);
		GameRegistry.addRecipe(new ItemStack(Transcraft.BunkerStair, 4), "  b", " bb",
				"bbb", 'b', Transcraft.BunkerBlock);
		GameRegistry.addRecipe(new ItemStack(Transcraft.SmoothBunkerBlock, 4), "bb", "bb",
				'b', Transcraft.BunkerBlock);
		GameRegistry.addRecipe(new ItemStack(Transcraft.SmoothBunkerStair, 4), "b  ",
				"bb ", "bbb", 'b', Transcraft.SmoothBunkerBlock);
		GameRegistry.addRecipe(new ItemStack(Transcraft.SmoothBunkerStair, 4), "  b",
				" bb", "bbb", 'b', Transcraft.SmoothBunkerBlock);

		GameRegistry.addRecipe(new ItemStack(Transcraft.Transcrafter), "ddd", "ece",
		...
		GameRegistry.addRecipe(new ItemStack(Transcraft.BlueLight, 8), "prp", "pbp",
				"prp", 'r', Item.redstone, 'p', Transcraft.Plastic, 'b', BlueDye);
		GameRegistry.addRecipe(new ItemStack(Transcraft.GreenLight, 8), "prp", "pbp",
				"prp", 'r', Item.redstone, 'p', Transcraft.Plastic, 'b', GreenDye);
		GameRegistry.addRecipe(new ItemStack(Transcraft.OrangeLight, 8), "prp", "pbp",
				"prp", 'r', Item.redstone, 'p', Transcraft.Plastic, 'b', OrangeDye);
		GameRegistry.addRecipe(new ItemStack(Transcraft.DarkLight, 8), "prp", "pbp",
				"prp", 'r', Item.redstone, 'p', Transcraft.Plastic, 'b', Block.obsidian);
		GameRegistry.addRecipe(new ItemStack(Transcraft.HardendPlastic, 8), "pop", "ooo",
				"pop", 'p', Transcraft.Plastic, 'o', Block.obsidian);

		GameRegistry.addRecipe(new ItemStack(Transcraft.IronStick, 4), " i ", " s ",
				" i ", 'i', Item.ingotIron, 's', Item.stick);
		GameRegistry.addRecipe(new ItemStack(Transcraft.IronTorch, 16), "o", "i", 'i',
				Transcraft.IronStick, 'o',Transcraft.Oil);

		GameRegistry.addRecipe(new ItemStack(Transcraft.PlasticSword), " p ", " p ",
				" i ", 'i', Transcraft.IronStick, 'p', Transcraft.Plastic);
		GameRegistry.addRecipe(new ItemStack(Transcraft.PlasticPickaxe), "ppp", " i ",
				" i ", 'i', Transcraft.IronStick, 'p', Transcraft.Plastic);
		GameRegistry.addRecipe(new ItemStack(Transcraft.PlasticAxe), " pp", " ip", " i ",
				'i', Transcraft.IronStick, 'p', Transcraft.Plastic);
		GameRegistry.addRecipe(new ItemStack(Transcraft.PlasticAxe), "pp ", "pi ", " i ",
				'i', Transcraft.IronStick, 'p', Transcraft.Plastic);
		GameRegistry.addRecipe(new ItemStack(Transcraft.PlasticHoe), "pp ", " i ", " i ",
				'i', Transcraft.IronStick, 'p',Transcraft. Plastic);
		GameRegistry.addRecipe(new ItemStack(Transcraft.PlasticHoe), " pp", " i ", " i ",
				'i', Transcraft.IronStick, 'p', Transcraft.Plastic);
		GameRegistry.addRecipe(new ItemStack(Transcraft.PlasticShovel), " p ", " i ",
				" i ", 'i',Transcraft. IronStick, 'p', Transcraft.Plastic);
		...
		GameRegistry.addRecipe(new ItemStack(Transcraft.EnderQuartz, 6), "qeq",
				"qdq", "qeq", 'q', Transcraft.DarkEndershard, 'd', Block.whiteStone,
				'e', Item.eyeOfEnder);
