...
public class LoadOreDics {
	...
	public static void oredic()
	{
		...
		OreDictionary
				.registerOre("TRANS-ComGoldOre", new ItemStack(Transcraft.ComGoldOre));
		OreDictionary
				.registerOre("TRANS-ComIronOre", new ItemStack(Transcraft.ComIronOre));
		...
		OreDictionary
				.registerOre("TRANS-BunkerPick", new ItemStack(Transcraft.BunkerPick));
		OreDictionary
				.registerOre("TRANS-EnderSword", new ItemStack(Transcraft.EnderSword));
