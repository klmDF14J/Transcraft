...
public class DimTp extends Teleporter
{
	...
	public boolean makePortal(Entity par1Entity)
	{
		...
		worldServerInstance.setBlock(i + 3, j + 14, k + 4, Transcraft.StairBlueenderQuartz.blockID, 2, 2);
		worldServerInstance.setBlock(i + 3, j + 14, k + 5, Transcraft.StairBlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 3, j + 14, k + 6, Transcraft.StairBlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 3, j + 14, k + 7, Transcraft.StairBlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 3, j + 14, k + 8, Transcraft.StairBlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 3, j + 14, k + 9, Transcraft.StairBlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 3, j + 14, k + 10, Transcraft.StairBlueenderQuartz.blockID, 3, 2);
		...
		worldServerInstance.setBlock(i + 4, j + 10, k + 5, Transcraft.BlueenderQuartz.blockID, 2, 2);
		worldServerInstance.setBlock(i + 4, j + 10, k + 6, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 4, j + 10, k + 7, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 4, j + 10, k + 8, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 4, j + 10, k + 9, Transcraft.BlueenderQuartz.blockID, 2, 2);
		worldServerInstance.setBlock(i + 4, j + 11, k + 5, Transcraft.BlueenderQuartz.blockID, 2, 2);
		worldServerInstance.setBlock(i + 4, j + 11, k + 9, Transcraft.BlueenderQuartz.blockID, 2, 2);
		worldServerInstance.setBlock(i + 4, j + 12, k + 5, Transcraft.BlueenderQuartz.blockID, 2, 2);
		worldServerInstance.setBlock(i + 4, j + 12, k + 9, Transcraft.BlueenderQuartz.blockID, 2, 2);
		worldServerInstance.setBlock(i + 4, j + 13, k + 5, Transcraft.BlueenderQuartz.blockID, 2, 2);
		worldServerInstance.setBlock(i + 4, j + 13, k + 9, Transcraft.BlueenderQuartz.blockID, 2, 2);
		worldServerInstance.setBlock(i + 4, j + 14, k + 3, Transcraft.StairBlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 4, j + 14, k + 4, Transcraft.StairBlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 4, j + 14, k + 5, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 4, j + 14, k + 6, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 4, j + 14, k + 7, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 4, j + 14, k + 8, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 4, j + 14, k + 9, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 4, j + 14, k + 10, Transcraft.StairBlueenderQuartz.blockID, 3, 2);
		worldServerInstance.setBlock(i + 4, j + 14, k + 11, Transcraft.StairBlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 4, j + 15, k + 5, Transcraft.StairBlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 4, j + 15, k + 6, Transcraft.StairBlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 4, j + 15, k + 7, Transcraft.StairBlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 4, j + 15, k + 8, Transcraft.StairBlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 4, j + 15, k + 9, Transcraft.StairBlueenderQuartz.blockID);
		...
		worldServerInstance.setBlock(i + 5, j + 8, k + 6, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 5, j + 8, k + 7, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 5, j + 8, k + 8, Transcraft.BlueenderQuartz.blockID);
		...
		worldServerInstance.setBlock(i + 5, j + 9, k + 6, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 5, j + 9, k + 7, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 5, j + 9, k + 8, Transcraft.BlueenderQuartz.blockID);
		...
		worldServerInstance.setBlock(i + 5, j + 10, k + 4, Transcraft.BlueenderQuartz.blockID, 2, 2);
		worldServerInstance.setBlock(i + 5, j + 10, k + 5, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 5, j + 10, k + 6, Transcraft.StairBlueenderQuartz.blockID, 1, 2);
		worldServerInstance.setBlock(i + 5, j + 10, k + 7, Transcraft.StairBlueenderQuartz.blockID, 1, 2);
		worldServerInstance.setBlock(i + 5, j + 10, k + 8, Transcraft.StairBlueenderQuartz.blockID, 1, 2);
		worldServerInstance.setBlock(i + 5, j + 10, k + 9, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 5, j + 10, k + 10, Transcraft.BlueenderQuartz.blockID, 2, 2);
		worldServerInstance.setBlock(i + 5, j + 11, k + 4, Transcraft.BlueenderQuartz.blockID, 2, 2);
		worldServerInstance.setBlock(i + 5, j + 11, k + 10, Transcraft.BlueenderQuartz.blockID, 2, 2);
		worldServerInstance.setBlock(i + 5, j + 12, k + 4, Transcraft.BlueenderQuartz.blockID, 2, 2);
		worldServerInstance.setBlock(i + 5, j + 12, k + 10, Transcraft.BlueenderQuartz.blockID, 2, 2);
		worldServerInstance.setBlock(i + 5, j + 13, k + 4, Transcraft.BlueenderQuartz.blockID, 2, 2);
		worldServerInstance.setBlock(i + 5, j + 13, k + 10, Transcraft.BlueenderQuartz.blockID, 2, 2);
		worldServerInstance.setBlock(i + 5, j + 14, k + 3, Transcraft.StairBlueenderQuartz.blockID, 2, 2);
		worldServerInstance.setBlock(i + 5, j + 14, k + 4, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 5, j + 14, k + 10, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 5, j + 14, k + 11, Transcraft.StairBlueenderQuartz.blockID, 3, 2);
		worldServerInstance.setBlock(i + 5, j + 15, k + 4, Transcraft.StairBlueenderQuartz.blockID, 2, 2);
		worldServerInstance.setBlock(i + 5, j + 15, k + 5, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 5, j + 15, k + 6, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 5, j + 15, k + 7, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 5, j + 15, k + 8, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 5, j + 15, k + 9, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 5, j + 15, k + 10, Transcraft.StairBlueenderQuartz.blockID, 3, 2);
		worldServerInstance.setBlock(i + 5, j + 16, k + 5, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 5, j + 16, k + 6, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 5, j + 16, k + 7, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 5, j + 16, k + 8, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 5, j + 16, k + 9, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 5, j + 17, k + 5, Transcraft.StairBlueenderQuartz.blockID, 2, 2);
		worldServerInstance.setBlock(i + 5, j + 17, k + 6, Transcraft.StairBlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 5, j + 17, k + 7, Transcraft.StairBlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 5, j + 17, k + 8, Transcraft.StairBlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 5, j + 17, k + 9, Transcraft.StairBlueenderQuartz.blockID);
		...
		worldServerInstance.setBlock(i + 6, j + 7, k + 6, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 6, j + 7, k + 7, Transcraft.BlueenderQuartz.blockID);
		...
		worldServerInstance.setBlock(i + 6, j + 8, k + 5, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 6, j + 8, k + 6, Config.DimPortalBlockID);
		worldServerInstance.setBlock(i + 6, j + 8, k + 7, Config.DimPortalBlockID);
		worldServerInstance.setBlock(i + 6, j + 8, k + 8, Config.DimPortalBlockID);
		worldServerInstance.setBlock(i + 6, j + 8, k + 9, Transcraft.BlueenderQuartz.blockID);
		...
		worldServerInstance.setBlock(i + 6, j + 9, k + 5, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 6, j + 9, k + 9, Transcraft.BlueenderQuartz.blockID);
		...
		worldServerInstance.setBlock(i + 6, j + 10, k + 4, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 6, j + 10, k + 5, Transcraft.StairBlueenderQuartz.blockID, 3, 2);
		worldServerInstance.setBlock(i + 6, j + 10, k + 9, Transcraft.StairBlueenderQuartz.blockID, 2, 2);
		worldServerInstance.setBlock(i + 6, j + 10, k + 10, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 6, j + 14, k + 3, Transcraft.StairBlueenderQuartz.blockID, 2, 2);
		worldServerInstance.setBlock(i + 6, j + 14, k + 4, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 6, j + 14, k + 10, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 6, j + 14, k + 11, Transcraft.StairBlueenderQuartz.blockID, 3, 2);
		worldServerInstance.setBlock(i + 6, j + 15, k + 4, Transcraft.StairBlueenderQuartz.blockID, 2, 2);
		worldServerInstance.setBlock(i + 6, j + 15, k + 5, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 6, j + 15, k + 9, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 6, j + 15, k + 10, Transcraft.StairBlueenderQuartz.blockID, 3, 2);
		worldServerInstance.setBlock(i + 6, j + 16, k + 5, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 6, j + 16, k + 9, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 6, j + 17, k + 5, Transcraft.StairBlueenderQuartz.blockID, 2, 2);
		worldServerInstance.setBlock(i + 6, j + 17, k + 6, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 6, j + 17, k + 7, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 6, j + 17, k + 8, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 6, j + 17, k + 9, Transcraft.StairBlueenderQuartz.blockID, 3, 2);
		worldServerInstance.setBlock(i + 6, j + 18, k + 6, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 6, j + 18, k + 7, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 6, j + 18, k + 8, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 6, j + 19, k + 6, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 6, j + 19, k + 7, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 6, j + 19, k + 8, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 6, j + 20, k + 6, Transcraft.StairBlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 6, j + 20, k + 7, Transcraft.StairBlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 6, j + 20, k + 8, Transcraft.StairBlueenderQuartz.blockID, 3, 2);
		...
		worldServerInstance.setBlock(i + 7, j + 7, k + 6, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 7, j + 7, k + 7, Transcraft.BlueenderQuartz.blockID);
		...
		worldServerInstance.setBlock(i + 7, j + 8, k + 5, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 7, j + 8, k + 6, Config.DimPortalBlockID);
		worldServerInstance.setBlock(i + 7, j + 8, k + 7, Config.DimPortalBlockID);
		worldServerInstance.setBlock(i + 7, j + 8, k + 8, Config.DimPortalBlockID);
		worldServerInstance.setBlock(i + 7, j + 8, k + 9, Transcraft.BlueenderQuartz.blockID);
		...
		worldServerInstance.setBlock(i + 7, j + 9, k + 5, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 7, j + 9, k + 9, Transcraft.BlueenderQuartz.blockID);
		...
		worldServerInstance.setBlock(i + 7, j + 10, k + 4, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 7, j + 10, k + 5, Transcraft.StairBlueenderQuartz.blockID, 3, 2);
		worldServerInstance.setBlock(i + 7, j + 10, k + 9, Transcraft.StairBlueenderQuartz.blockID, 2, 2);
		worldServerInstance.setBlock(i + 7, j + 10, k + 10, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 7, j + 14, k + 3, Transcraft.StairBlueenderQuartz.blockID, 2, 2);
		worldServerInstance.setBlock(i + 7, j + 14, k + 4, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 7, j + 14, k + 10, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 7, j + 14, k + 11, Transcraft.StairBlueenderQuartz.blockID, 3, 2);
		worldServerInstance.setBlock(i + 7, j + 15, k + 4, Transcraft.StairBlueenderQuartz.blockID, 2, 2);
		worldServerInstance.setBlock(i + 7, j + 15, k + 5, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 7, j + 15, k + 9, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 7, j + 15, k + 10, Transcraft.StairBlueenderQuartz.blockID, 3, 2);
		worldServerInstance.setBlock(i + 7, j + 16, k + 5, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 7, j + 16, k + 9, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 7, j + 17, k + 5, Transcraft.StairBlueenderQuartz.blockID, 2, 2);
		worldServerInstance.setBlock(i + 7, j + 17, k + 6, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 7, j + 17, k + 8, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 7, j + 17, k + 9, Transcraft.StairBlueenderQuartz.blockID, 3, 2);
		worldServerInstance.setBlock(i + 7, j + 18, k + 6, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 7, j + 18, k + 8, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 7, j + 19, k + 6, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 7, j + 19, k + 8, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 7, j + 20, k + 6, Transcraft.StairBlueenderQuartz.blockID, 2, 2);
		worldServerInstance.setBlock(i + 7, j + 20, k + 7, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 7, j + 20, k + 8, Transcraft.StairBlueenderQuartz.blockID, 3, 2);
		worldServerInstance.setBlock(i + 7, j + 21, k + 7, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 7, j + 22, k + 7, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 7, j + 23, k + 7, Transcraft.BlueenderQuartz.blockID);
		...
		worldServerInstance.setBlock(i + 8, j + 7, k + 8, Transcraft.BlueenderQuartz.blockID);
		...
		worldServerInstance.setBlock(i + 8, j + 8, k + 5, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 8, j + 8, k + 6, Config.DimPortalBlockID);
		worldServerInstance.setBlock(i + 8, j + 8, k + 7, Config.DimPortalBlockID);
		worldServerInstance.setBlock(i + 8, j + 8, k + 8, Config.DimPortalBlockID);
		worldServerInstance.setBlock(i + 8, j + 8, k + 9, Transcraft.BlueenderQuartz.blockID);
		...
		worldServerInstance.setBlock(i + 8, j + 9, k + 5, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 8, j + 9, k + 9, Transcraft.BlueenderQuartz.blockID);
		...
		worldServerInstance.setBlock(i + 8, j + 10, k + 5, Transcraft.StairBlueenderQuartz.blockID, 3, 2);
		worldServerInstance.setBlock(i + 8, j + 10, k + 9, Transcraft.StairBlueenderQuartz.blockID, 2, 2);
		worldServerInstance.setBlock(i + 8, j + 10, k + 10, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 8, j + 14, k + 3, Transcraft.StairBlueenderQuartz.blockID, 2, 2);
		worldServerInstance.setBlock(i + 8, j + 14, k + 4, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 8, j + 14, k + 10, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 8, j + 14, k + 11, Transcraft.StairBlueenderQuartz.blockID, 3, 2);
		worldServerInstance.setBlock(i + 8, j + 15, k + 4, Transcraft.StairBlueenderQuartz.blockID, 2, 2);
		worldServerInstance.setBlock(i + 8, j + 15, k + 5, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 8, j + 15, k + 9, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 8, j + 15, k + 10, Transcraft.StairBlueenderQuartz.blockID, 3, 2);
		worldServerInstance.setBlock(i + 8, j + 16, k + 5, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 8, j + 16, k + 9, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 8, j + 17, k + 5, Transcraft.StairBlueenderQuartz.blockID, 2, 2);
		worldServerInstance.setBlock(i + 8, j + 17, k + 6, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 8, j + 17, k + 7, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 8, j + 17, k + 8, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 8, j + 17, k + 9, Transcraft.StairBlueenderQuartz.blockID, 3, 2);
		worldServerInstance.setBlock(i + 8, j + 18, k + 6, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 8, j + 18, k + 7, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 8, j + 18, k + 8, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 8, j + 19, k + 6, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 8, j + 19, k + 7, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 8, j + 19, k + 8, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 8, j + 20, k + 6, Transcraft.StairBlueenderQuartz.blockID, 1, 2);
		worldServerInstance.setBlock(i + 8, j + 20, k + 7, Transcraft.StairBlueenderQuartz.blockID, 1, 2);
		worldServerInstance.setBlock(i + 8, j + 20, k + 8, Transcraft.StairBlueenderQuartz.blockID, 3, 2);
		...
		worldServerInstance.setBlock(i + 9, j + 8, k + 6, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 9, j + 8, k + 7, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 9, j + 8, k + 8, Transcraft.BlueenderQuartz.blockID);
		...
		worldServerInstance.setBlock(i + 9, j + 9, k + 6, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 9, j + 9, k + 7, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 9, j + 9, k + 8, Transcraft.BlueenderQuartz.blockID);
		...
		worldServerInstance.setBlock(i + 9, j + 10, k + 4, Transcraft.BlueenderQuartz.blockID, 2, 2);
		worldServerInstance.setBlock(i + 9, j + 10, k + 5, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 9, j + 10, k + 6, Transcraft.StairBlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 9, j + 10, k + 7, Transcraft.StairBlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 9, j + 10, k + 8, Transcraft.StairBlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 9, j + 10, k + 9, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 9, j + 10, k + 10, Transcraft.BlueenderQuartz.blockID, 2, 2);
		worldServerInstance.setBlock(i + 9, j + 11, k + 4, Transcraft.BlueenderQuartz.blockID, 2, 2);
		worldServerInstance.setBlock(i + 9, j + 11, k + 10, Transcraft.BlueenderQuartz.blockID, 2, 2);
		worldServerInstance.setBlock(i + 9, j + 12, k + 4, Transcraft.BlueenderQuartz.blockID, 2, 2);
		worldServerInstance.setBlock(i + 9, j + 12, k + 10, Transcraft.BlueenderQuartz.blockID, 2, 2);
		worldServerInstance.setBlock(i + 9, j + 13, k + 4, Transcraft.BlueenderQuartz.blockID, 2, 2);
		worldServerInstance.setBlock(i + 9, j + 13, k + 10, Transcraft.BlueenderQuartz.blockID, 2, 2);
		worldServerInstance.setBlock(i + 9, j + 14, k + 3, Transcraft.StairBlueenderQuartz.blockID, 2, 2);
		worldServerInstance.setBlock(i + 9, j + 14, k + 4, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 9, j + 14, k + 10, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 9, j + 14, k + 11, Transcraft.StairBlueenderQuartz.blockID, 3, 2);
		worldServerInstance.setBlock(i + 9, j + 15, k + 4, Transcraft.StairBlueenderQuartz.blockID, 2, 2);
		worldServerInstance.setBlock(i + 9, j + 15, k + 5, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 9, j + 15, k + 6, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 9, j + 15, k + 7, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 9, j + 15, k + 8, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 9, j + 15, k + 9, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 9, j + 15, k + 10, Transcraft.StairBlueenderQuartz.blockID, 3, 2);
		worldServerInstance.setBlock(i + 9, j + 16, k + 5, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 9, j + 16, k + 6, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 9, j + 16, k + 7, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 9, j + 16, k + 8, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 9, j + 16, k + 9, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 9, j + 17, k + 5, Transcraft.StairBlueenderQuartz.blockID, 2, 2);
		worldServerInstance.setBlock(i + 9, j + 17, k + 6, Transcraft.StairBlueenderQuartz.blockID, 1, 2);
		worldServerInstance.setBlock(i + 9, j + 17, k + 7, Transcraft.StairBlueenderQuartz.blockID, 1, 2);
		worldServerInstance.setBlock(i + 9, j + 17, k + 8, Transcraft.StairBlueenderQuartz.blockID, 1, 2);
		worldServerInstance.setBlock(i + 9, j + 17, k + 9, Transcraft.StairBlueenderQuartz.blockID, 3, 2);
		...
		worldServerInstance.setBlock(i + 10, j + 10, k + 5, Transcraft.BlueenderQuartz.blockID, 2, 2);
		worldServerInstance.setBlock(i + 10, j + 10, k + 6, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 10, j + 10, k + 7, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 10, j + 10, k + 8, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 10, j + 10, k + 9, Transcraft.BlueenderQuartz.blockID, 2, 2);
		worldServerInstance.setBlock(i + 10, j + 11, k + 5, Transcraft.BlueenderQuartz.blockID, 2, 2);
		worldServerInstance.setBlock(i + 10, j + 11, k + 9, Transcraft.BlueenderQuartz.blockID, 2, 2);
		worldServerInstance.setBlock(i + 10, j + 12, k + 5, Transcraft.BlueenderQuartz.blockID, 2, 2);
		worldServerInstance.setBlock(i + 10, j + 12, k + 9, Transcraft.BlueenderQuartz.blockID, 2, 2);
		worldServerInstance.setBlock(i + 10, j + 13, k + 5, Transcraft.BlueenderQuartz.blockID, 2, 2);
		worldServerInstance.setBlock(i + 10, j + 13, k + 9, Transcraft.BlueenderQuartz.blockID, 2, 2);
		worldServerInstance.setBlock(i + 10, j + 14, k + 3, Transcraft.StairBlueenderQuartz.blockID, 1, 2);
		worldServerInstance.setBlock(i + 10, j + 14, k + 4, Transcraft.StairBlueenderQuartz.blockID, 2, 2);
		worldServerInstance.setBlock(i + 10, j + 14, k + 5, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 10, j + 14, k + 6, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 10, j + 14, k + 7, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 10, j + 14, k + 8, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 10, j + 14, k + 9, Transcraft.BlueenderQuartz.blockID);
		worldServerInstance.setBlock(i + 10, j + 14, k + 10, Transcraft.StairBlueenderQuartz.blockID, 1, 2);
		worldServerInstance.setBlock(i + 10, j + 14, k + 11, Transcraft.StairBlueenderQuartz.blockID, 1, 2);
		worldServerInstance.setBlock(i + 10, j + 15, k + 5, Transcraft.StairBlueenderQuartz.blockID, 1, 2);
		worldServerInstance.setBlock(i + 10, j + 15, k + 6, Transcraft.StairBlueenderQuartz.blockID, 1, 2);
		worldServerInstance.setBlock(i + 10, j + 15, k + 7, Transcraft.StairBlueenderQuartz.blockID, 1, 2);
		worldServerInstance.setBlock(i + 10, j + 15, k + 8, Transcraft.StairBlueenderQuartz.blockID, 1, 2);
		worldServerInstance.setBlock(i + 10, j + 15, k + 9, Transcraft.StairBlueenderQuartz.blockID, 1, 2);
		...
		worldServerInstance.setBlock(i + 11, j + 14, k + 4, Transcraft.StairBlueenderQuartz.blockID, 2, 2);
		worldServerInstance.setBlock(i + 11, j + 14, k + 5, Transcraft.StairBlueenderQuartz.blockID, 1, 2);
		worldServerInstance.setBlock(i + 11, j + 14, k + 6, Transcraft.StairBlueenderQuartz.blockID, 1, 2);
		worldServerInstance.setBlock(i + 11, j + 14, k + 7, Transcraft.StairBlueenderQuartz.blockID, 1, 2);
		worldServerInstance.setBlock(i + 11, j + 14, k + 8, Transcraft.StairBlueenderQuartz.blockID, 1, 2);
		worldServerInstance.setBlock(i + 11, j + 14, k + 9, Transcraft.StairBlueenderQuartz.blockID, 1, 2);
		worldServerInstance.setBlock(i + 11, j + 14, k + 10, Transcraft.StairBlueenderQuartz.blockID, 3, 2);
