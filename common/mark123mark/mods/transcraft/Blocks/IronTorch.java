...
public class IronTorch extends Block
{
...
//        this.setCreativeTab(CreativeTabs.tabDecorations);
 ...
 //           par1World.spawnParticle("enchantmenttable", d0 - d4, d1 + d3, d2, 0.0D, 0.0D, 0.0D);
        }
        else if (l == 2)
        {
            par1World.spawnParticle("smoke", d0 + d4, d1 + d3, d2, 0.0D, 0.0D, 0.0D);
...
//            par1World.spawnParticle("enchantmenttable", d0, d1 + d3, d2 - d4, 0.0D, 0.0D, 0.0D);
        }
        else if (l == 4)
        {
            par1World.spawnParticle("smoke", d0, d1 + d3, d2 + d4, 0.0D, 0.0D, 0.0D);
//            par1World.spawnParticle("enchantmenttable", d0, d1 + d3, d2 + d4, 0.0D, 0.0D, 0.0D);
 ...
 //           par1World.spawnParticle("enchantmenttable", d0, d1, d2, 0.0D, 0.0D, 0.0D);
        }
    }
