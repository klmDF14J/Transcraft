...
public class ThinBase extends Block
{
    ...
    public ThinBase(int id, Material material, String folder, String[] blockTextures)
    {
        super(id, material);
    ...
    public boolean canConnectTo (int blockID)
    {
        ...
        return Block.opaqueCubeLookup[blockID] || block instanceof ThinBase || block instanceof BlockPane || blockID == Block.glass.blockID;
    }
    ...
    public void registerIcons (IconRegister iconRegister)
    {
        ...
        {
            this.icons[i] = iconRegister.registerIcon("Transcraft:" + folder + textureNames[i]);
            this.sideIcons[i] = iconRegister.registerIcon("Transcraft:" + folder + textureNames[i] + "_side");
        }
    }
