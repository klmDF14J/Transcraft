package mark123mark.mods.transcraft.particles;
...
public class GlassFX extends EntityFX {

	private static final String texture = "transcraft:textures/particles/steam.png";
		float steamParticleScale;

    public GlassFX(World par1World, double par2, double par4, double par6, double par8, double par10, double par12)
    {
            this(par1World, par2, par4, par6, par8, par10, par12, 1.0F);
    }

    public GlassFX(World par1World, double par2, double par4, double par6, double par8, double par10, double par12, float par14)
    {
